...
def preencher_table():
    ...
    hospital = [
        # Hospital de Picos
        Hospital(cidade_fk=1, hospital="Hospital Regional De Picos", endereco="Praça Antenor Neiva, 184 - Bomba"),
        Hospital(cidade_fk=1, hospital="UPA 24h - Picos", endereco="R. Joaquim Pacifico da Silva - Catavento"),
        # Hospital de Floriano 
        Hospital(cidade_fk=2, hospital="Hospital Regional Tibério Nunes", endereco="R. Gabriel Ferreira, S/N - Manguinha"),
        Hospital(cidade_fk=2, hospital="UPA - Floriano", endereco="R. João Justino - Matadouro"),
        # Hospital de Teresina
        Hospital(cidade_fk=3, hospital="Hospital do Monte Castelo", endereco="R. Antônio Cavour de Miranda, 357 - Monte Castelo"),
        Hospital(cidade_fk=3, hospital="Hospital Santa Maria", endereco="Rua Governador Raimundo Artur de Vasconcelos, 616 - Centro (Sul)"),
        # Hostital de Paraiba
        Hospital(cidade_fk=4, hospital="Hospital Estadual Dirceu Arcoverde", endereco="R. Rodrigues Coimbra, 1650 - Rodoviária")
    ]
